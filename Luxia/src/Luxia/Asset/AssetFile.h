...
namespace Luxia::Assets {
	...
	public:
		...
		virtual bool Create(const std::filesystem::path& m_srcPath, const std::filesystem::path& m_metaPath, const std::string& m_name, const AssetType& m_type); // Create the metafile from a source
